    ...
    <div class="container">
        <div class="wrapper p-5 m-5">
            <div class="d-flex p-2 justify-content-between">
                ...
                <div><a href="index.php"><i data-feather="corner-down-left"></a></i></div>
            </div>
            <form action="index.php" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" value="<?php echo $password; ?>" placeholder=" enter your password " name="password" autocomplete="false">
                </div>
                <?php
